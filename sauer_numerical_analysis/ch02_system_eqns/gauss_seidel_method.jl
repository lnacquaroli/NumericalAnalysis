...
md"### Iterative methods: Gauss-Seidel method
...
"""
Implements the Gauss-Seidel method for solving the system Ax=b.
A must be square and strictly diagonally dominant.

	sol = gauss_seidel_method(A, b, x₀; k=10, δ=1.0e-6)
...
"""
function gauss_seidel_method(A, b, x₀; k=10, δ=1.0e-6)
	m, n = size(A)
...
sol = gauss_seidel_method(float.(A), float.(b), zeros(3))
